...
TECHNOLOGY_CLASS_MATCH = """
MATCH (tc:TechnologyClass1 {name: $value})-[:HAS_TECHNOLOGY_CLASS1]-(tp:TargetPair)-[:HAS_TARGET_PAIR]-(p:Patent)-[:PUBLISHED_IN]-(y:Year)
"""


def technology_class_queries() -> list[QueryDefinition]:
    return [
        QueryDefinition(
            name="summary",
            description="Core patent and family counts for a technology class.",
            default_limit=1,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
...
""",
        ...
        QueryDefinition(
            name="yearly_trend",
            description="Yearly publication counts for a technology class.",
            default_limit=100,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
...
""",
        ...
        QueryDefinition(
            ...
            description="Top target pairs in a technology class.",
            default_limit=20,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
...
""",
        ...
        QueryDefinition(
            name="top_targets",
            description="Top targets in a technology class.",
            default_limit=20,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
MATCH (tp)-[:HAS_TARGET]-(t:Target)
...
""",
        ...
        QueryDefinition(
            name="top_assignees",
            description="Top assignees in a technology class.",
            default_limit=20,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
...
""",
        ...
        QueryDefinition(
            ...
            description="Functional roles represented by targets in a technology class.",
            default_limit=50,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
MATCH (tp)-[:HAS_TARGET]-(t:Target)
...
""",
        ...
        QueryDefinition(
            ...
            description="Representative patent publications for a technology class.",
            default_limit=50,
            cypher=TECHNOLOGY_CLASS_MATCH
            + """
OPTIONAL MATCH (p)-[:HAS_ASSIGNEE]-(a:Assignee)
OPTIONAL MATCH (p)-[:HAS_PATENT]-(fam:Family)
WITH p, tp, a, fam, toInteger(y.year) AS year
WHERE year >= $year_min AND year <= $year_max
